...
"""
Samples a large number of images from a pre-trained ARFlow model using DDP.
...
def main(args):
    ...
    # Auto-download a pre-trained model or load a custom ARFlow checkpoint from train.py:
    ckpt_path = args.ckpt 
    ...
    folder_name = f"{model_string_name}-{ckpt_string_name}-" \
                ...
                f"{args.num_sampling_steps}-{args.sampling_method}-"\
